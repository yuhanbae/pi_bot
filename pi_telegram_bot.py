...
def build_model_keyboard(current_model, limit=8):
                ...
                if cb:
                    ...
                    if data_cb.startswith("model:"):
                        ...
                        if new_model!='refresh':
                            ...
                            send_message_with_keyboard(chat_id, f"Current model: {current_model}", build_model_keyboard(current_model))
                        continue
